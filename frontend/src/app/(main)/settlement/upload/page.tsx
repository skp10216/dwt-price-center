              ...
              <Box sx={{ mb: 2 }}>
                <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 0.5 }}>
                  ...
                  <Typography variant="caption" fontWeight={600}>
                    {Object.values(mappingActions).filter(a => a.action === 'skip').length}건 처리 완료 / {unmatchedList.length}건
                  </Typography>
                </Stack>
                <LinearProgress
                  variant="determinate"
                  value={unmatchedList.length > 0 ? (Object.values(mappingActions).filter(a => a.action === 'skip').length / unmatchedList.length) * 100 : 0}
              ...
              <Box>
                <Paper elevation={0} sx={{ p: 3, mb: 3, border: '1px solid', borderColor: 'divider', borderRadius: 3 }}>
                  ...
                  <Stack direction="row" spacing={2} sx={{ mb: 3 }} flexWrap="wrap" useFlexGap>
                    <Paper variant="outlined" sx={{ p: 2, minWidth: 90, textAlign: 'center', borderRadius: 2 }}>
                    ...
                    <Paper variant="outlined" sx={{ p: 2, minWidth: 90, textAlign: 'center', borderRadius: 2, borderColor: 'success.main', bgcolor: alpha(theme.palette.success.main, 0.04) }}>
                    ...
                    <Paper variant="outlined" sx={{ p: 2, minWidth: 90, textAlign: 'center', borderRadius: 2, borderColor: 'info.main', bgcolor: alpha(theme.palette.info.main, 0.04) }}>
                    ...
                    {(stats?.error ?? 0) > 0 && (
                      <Paper variant="outlined" sx={{ p: 2, minWidth: 90, textAlign: 'center', borderRadius: 2, borderColor: 'error.main', bgcolor: alpha(theme.palette.error.main, 0.04) }}>
                    ...
                    {(stats?.unmatched ?? 0) > 0 && (
                      <Paper variant="outlined" sx={{ p: 2, minWidth: 90, textAlign: 'center', borderRadius: 2, borderColor: 'warning.main', bgcolor: alpha(theme.palette.warning.main, 0.04) }}>
                  ...
                  {/* 미리보기 테이블 */}
                  <Typography variant="subtitle2" fontWeight={700} sx={{ mb: 1 }}>데이터 미리보기</Typography>
                  <TableContainer sx={{ maxHeight: 300, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
                    <Table size="small" stickyHeader>
                      ...
                      <TableBody>
                        {jobDetail?.preview_rows.slice(0, 50).map((row) => {
                        ...
                        {(jobDetail?.preview_rows.length ?? 0) > 50 && (
                          <TableRow>
                            <TableCell colSpan={5} align="center" sx={{ py: 2 }}>
                              <Typography variant="caption" color="text.secondary">
                                …외 {(jobDetail?.preview_rows.length ?? 0) - 50}건
                              </Typography>
                            </TableCell>
                          </TableRow>
                        )}
