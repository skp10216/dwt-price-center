...
export const settlementApi = {
  ...
  exportCounterpartyDetailExcel: (counterpartyId: string, params?: Record<string, unknown>) =>
    api.get(`/settlement/dashboard/counterparty/${counterpartyId}/export`, { params, responseType: 'blob' }),
